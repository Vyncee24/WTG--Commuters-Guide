...
-- Generated: 2026-06-09T07:24:48.285Z
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `role`, `status`, `created_at`, `updated_at`) VALUES
  ...
  (8, 'ADMIN', 'admin@gmail.com', '$2a$10$YVuBHw3XJBKNoQrztSLrweT7E65/LCgB3kUw7WqeO4cHrQyQFdHMq', 'admin', 'active', '2026-06-07 18:19:44', '2026-06-07 18:20:39');
...
INSERT INTO `routes` (`id`, `route_id`, `from_location`, `to_location`, `duration`, `fare`, `transport_type`, `tags`, `steps`, `created_at`, `map_embed_url`, `search_count`) VALUES
  ...
  (17, 'cvsu-ccat_sm-tanza', 'CVSU CCAT', 'SM TANZA', '15 mins', '₱25', 'jeep', '["Mall","Hangouts"]', '[{"num":1,"title":"Ride a jeepney at the front of CVSU CCAT","transport":"jeep","instruction":"Ride a jeepney in front of CVSU CCAT Gate 2, DO NOT CROSS TO MCDO","signboard":"Tanza Loob, Tanza","alightAt":"Sm Tanza","fare":"₱25","mapEmbed":"https://www.google.com/maps/embed?pb=!4v1780625115712!6m8!1m7!1sX9TuVVGpRDDz4vpxjxTFAg!2m2!1d14.39238610532393!2d120.8522547546623!3f291.4761762109243!4f5.688661180229005!5f0.7820865974627469\\" width=\\"600\\" height=\\"450\\" style=\\"border:0;\\" allowfullscreen=\\"\\" loading=\\"lazy\\" referrerpolicy=\\"no-referrer-when-downgrade"}]', '2026-06-05 02:09:38', NULL, 13),
  (18, 'robinson-gen-tri_sm-tanza', 'Robinson Gen Tri', 'SM Tanza', '15 mins', '₱20', 'jeep,bus,baby_bus', '["Mall","Hangouts","SM"]', '[{"num":1,"title":"Ride a Bus/Jeepney to SM Tanza","transport":"jeep,bus,baby_bus","instruction":"Ride a baby bus in front of Robinson that has a signboard going tanza or naic or ternate","signboard":"Look for: \\"Tanza, Naic, Ternate\\"","alightAt":"Front of SM tanza","fare":"₱25","mapEmbed":"https://www.google.com/maps/embed?pb=!4v1780987176932!6m8!1m7!1sX9TuVVGpRDDz4vpxjxTFAg!2m2!1d14.39238610532393!2d120.8522547546623!3f277.1327105940741!4f-1.165406380155602!5f0.5344603183955186\\" width=\\"600\\" height=\\"450\\" style=\\"border:0;\\" allowfullscreen=\\"\\" loading=\\"lazy\\" referrerpolicy=\\"no-referrer-when-downgrade"}]', '2026-06-09 06:40:25', NULL, 3),
  (19, 'maple-grove_aguinaldo-freedom-park-kawit', 'Maple Grove', 'Aguinaldo Freedom Park Kawit', '15 mins', '₱25', 'jeep', '["Park","Foodtrip"]', '[{"num":1,"title":"Ride a jeepney to Kawit","transport":"jeep","instruction":"Ride a jeepney outside of Maple Grove and look for a jeepney that has a signboard Kawit, Potol, Binakayan\\nDO NOT: Ride a jeepney without \\"potol\\" signboard","signboard":"Look for: \\"Kawit, Potol, Binakayan\\"","alightAt":"In front of Aguinaldo Freedom Park","fare":"₱25","mapEmbed":"https://www.google.com/maps/embed?pb=!4v1780989611104!6m8!1m7!1sEVyruKLGiTMJU6jrRBa_IA!2m2!1d14.44623215076568!2d120.906519058741!3f159.14360278713843!4f-2.5903851588609825!5f1.0893434486030196\\" width=\\"600\\" height=\\"450\\" style=\\"border:0;\\" allowfullscreen=\\"\\" loading=\\"lazy\\" referrerpolicy=\\"no-referrer-when-downgrade"}]', '2026-06-09 07:21:01', NULL, 1);
...
INSERT INTO `search_history` (`id`, `user_id`, `route_id`, `origin`, `destination`, `searched_at`) VALUES
  ...
  (35, 8, 'cvsu-ccat_cvsu-main', 'CVSU CCAT', 'CVSU MAIN', '2026-06-07 18:32:02'),
  (36, 8, 'cvsu-ccat_sm-tanza', 'CVSU CCAT', 'SM TANZA', '2026-06-08 23:44:37'),
  (37, 8, 'robinson-gen-tri_sm-tanza', 'Robinson Gen Tri', 'SM Tanza', '2026-06-09 06:41:18'),
  (38, 8, 'robinson-gen-tri_sm-tanza', 'Robinson Gen Tri', 'SM Tanza', '2026-06-09 06:41:30'),
  (39, NULL, 'cvsu-ccat_sm-tanza', 'CVSU CCAT', 'SM TANZA', '2026-06-09 07:00:02'),
  (40, 8, 'robinson-gen-tri_sm-tanza', 'Robinson Gen Tri', 'SM Tanza', '2026-06-09 07:09:07'),
  (41, 8, 'maple-grove_aguinaldo-freedom-park-kawit', 'Maple Grove', 'Aguinaldo Freedom Park Kawit', '2026-06-09 07:22:29');

SET FOREIGN_KEY_CHECKS = 1;

-- Export complete: 2026-06-09T07:24:48.290Z